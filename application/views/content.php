<main class="content">
				<div class="slider">
					<ul class="slides">
						<li data-background="<?=base_url()?>assets/dummy/1.jpg">
							<div class="container">
						...
						<li data-background="<?=base_url()?>assets/dummy/slide-2.jpg">
							<div class="container">
								<div class="slide-caption col-md-4">
									<h2 class="slide-title">Venenatis felis pulvinar ultrices</h2>
						...
						<li data-background="<?=base_url()?>assets/dummy/slide-3.jpg">
							<div class="container">
								<div class="slide-caption col-md-4">
									<h2 class="slide-title">Venenatis felis pulvinar ultrices</h2>
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn">
									<figure class="featured-image"><img src="<?=base_url()?>assets/dummy/offer-thumbnail-1.jpg" alt=""></figure>
									<h2 class="entry-title"><a href="<?=base_url()?>assets/">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="<?=base_url()?>assets/#" class="button">See details</a>
								</article>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".2s">
									<figure class="featured-image"><img src="<?=base_url()?>assets/dummy/offer-thumbnail-2.jpg" alt=""></figure>
									<h2 class="entry-title"><a href="<?=base_url()?>assets/">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="<?=base_url()?>assets/#" class="button">See details</a>
								</article>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".4s">
									<figure class="featured-image"><img src="<?=base_url()?>assets/dummy/offer-thumbnail-3.jpg" alt=""></figure>
									<h2 class="entry-title"><a href="<?=base_url()?>assets/">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="<?=base_url()?>assets/#" class="button">See details</a>
								</article>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".6s">
									<figure class="featured-image"><img src="<?=base_url()?>assets/dummy/offer-thumbnail-4.jpg" alt=""></figure>
									<h2 class="entry-title"><a href="<?=base_url()?>assets/">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="<?=base_url()?>assets/#" class="button">See details</a>
								</article>
						...
						<div class="row">
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp">
									<figure class="avatar"><img src="<?=base_url()?>assets/dummy/person-1.jpg" alt=""></figure>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp" data-wow-delay=".2s">
									<figure class="avatar"><img src="<?=base_url()?>assets/dummy/person-2.jpg" alt=""></figure>
									<blockquote class="testimonial-body">
										<p>Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp" data-wow-delay=".4s">
									<figure class="avatar"><img src="<?=base_url()?>assets/dummy/person-3.jpg" alt=""></figure>
									<blockquote class="testimonial-body">
										<p>Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<div class="testimonial wow fadeInUp" data-wow-delay=".6s">
									<figure class="avatar"><img src="<?=base_url()?>assets/dummy/person-4.jpg" alt=""></figure>
									<blockquote class="testimonial-body">
										<p>Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
